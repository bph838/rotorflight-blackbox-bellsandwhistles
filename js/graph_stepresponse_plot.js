...
const STEP_RESPONSE_MARGIN = 10,
  ...
  STEP_RESPONSE_LINEWIDTH = 2, // response line width for the on-screen panel
  AILINEWIDTH = 3, // response line width used only for images captured for the AI Analyse feature
...
StepResponsePlot._drawMousePosition = function (canvasCtx) {
  ...
  for (const axis in STEP_RESPONSE_AXIS_LABELS) {
    ...
    this._drawLabel(
      ...
      labelAlign,
      "top",
      STEP_RESPONSE_AXIS_COLORS[axis],
    );
    lineIndex++;
  }
